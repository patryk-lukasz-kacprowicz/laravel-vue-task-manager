                    ...
                    <div class="p-6 bg-neutral-900 rounded-lg shadow-2xl mt-4 mb-2">
                        ...
                        <form @submit.prevent="submitForm" class="space-y-6">
                            <div>
                                ...
                                <input type="text" id="title" v-model="form.title" class="form-input block w-full bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500 rounded-lg" placeholder="Create app" required />
                            ...
                            <div>
                                ...
                                <textarea id="description" v-model="form.description" rows="4" class="form-textarea block w-full bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500 rounded-lg" placeholder="Application must be well made!" />
